...
//        window.plugin.bookmarks.saveStorage();
  ...
  var setup = function(){
    // check if new bookmarks with integrated MPE code is already in use
    if(window.plugin.bookmarks && window.plugin.bookmarks.initMPE) {
      alert ("Plugin 'MPE-Bookmarks' is obsolete, functions has been integrated to Bookmarks! Please disable this plugin.");
      return;
    };

    // check if multi-project-extension is loaded
